...
import { FullPageSpinner, BorrowStatusBadge } from '@/core/components/ui';
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([profRes, borrRes]) => {
        ...
        if (borrRes?.data.success && borrRes.data.data) {
          setBorrows(borrRes.data.data.activeBorrows);
        }
      })
