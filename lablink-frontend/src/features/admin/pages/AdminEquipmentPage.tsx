...
import { FullPageSpinner, EmptyState, ConfirmDialog, EquipmentStatusBadge, Modal, Spinner } from '@/core/components/ui';
import { PageHeader } from '@/core/components/layout/Sidebar';
import type { Equipment, Category, CreateEquipmentRequest, UpdateEquipmentRequest } from '@/features/equipment/types';
